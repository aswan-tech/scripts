...
foreach($collection as $val) {
    ...
    foreach( $datacat as $subcatid ) {
        ...
        $attribute = Mage::getModel('eav/config')->getAttribute('catalog_product', 'product_department');
            ...
            if($subCatName == $label) {
                ...
                if($row['count']>0){
                    ...
                    if($total['count']>0){
                        ...
                        $sql = "update catalog_product_entity_varchar set value = '".$option['value']."' where entity_type_id='4' and store_id='".$store_id."' and  entity_id='".$val['entity_id']."' and attribute_id='".$attrid."' ";
                    }else {
