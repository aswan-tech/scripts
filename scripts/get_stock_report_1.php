...
echo ("\"ProductName\",\"Category\",\"Subcategories\",\"ConfigSKU\",\"SimpleSKU\",\"Color\",\"Colors\",\"Gender\",\"Brand\",\"Collections\",\"Season\",\"Size\",\"EAN\",\"Price\",\"SpecialPrice\",\"Discount\",\"AvaiableStock\"\n");
	...
	foreach ($collection as $product) {
		...
		// season
		$seasonAttr = $_product->setStoreFilter(0)->getResource()->getAttribute("sizechart");
		$_options = $seasonAttr->getSource()->getAllOptions(true, true);
		
		foreach($_options as $option) {
			if ($option['value'] == $_product->getData('sizechart')) {
		...
		echo '"'.$dataArr['name'].'","'.$dataArr['catname'].'","'.$dataArr['SubCategory'].'","'.$dataArr['configSKU'].'","'.$dataArr['simpleSKU'].'","'.$dataArr['color'].'","'.$dataArr['colors'].'","'.$dataArr['gender'].'","'.$dataArr['brand'].'","'.$dataArr['collections'].'","'.$dataArr['season'].'","'.$dataArr['size'].'","'.$dataArr['ean'].'","'.$dataArr['price'].'","'.$dataArr['specialprice'].'","'.$discount_label.'","'.$dataArr['stock'].'"'."\n";
	}
?>
