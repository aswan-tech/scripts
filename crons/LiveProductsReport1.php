...
if($k=='Men')
	$men_map = getSubcategory($d);
else if($k=='Women')
	$women_map = getSubcategory($d);
else if($k=='Accessories')
	$accessories_map = getSubcategory($d);
else if($k=='Footwear')
	$footwear_map = getSubcategory($d);
}
function getSubcategory($_rootCatId){
        $data = array();
        $excluded_array = array('344','345','158','501','521','162','349','511','531','348','152','154','186');
